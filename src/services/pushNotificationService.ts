...
class PushNotificationService {
  ...
  async sendNotificationToBooking(bookingId: string, notification: PushNotification): Promise<void> {
    try {
  ...
  static createBookingConfirmedNotification(bookingId: string, gearTitle: string): PushNotification {
    return {
  ...
  static createPaymentReceivedNotification(bookingId: string, amount: number): PushNotification {
    return {
  ...
  static createNewMessageNotification(bookingId: string, senderName: string): PushNotification {
    return {
  ...
  static createClaimSubmittedNotification(bookingId: string, gearTitle: string): PushNotification {
    return {
  ...
  static createPickupReminderNotification(bookingId: string, gearTitle: string, startDate: string): PushNotification {
    return {
  ...
  static createReturnReminderNotification(bookingId: string, gearTitle: string, endDate: string): PushNotification {
    return {
