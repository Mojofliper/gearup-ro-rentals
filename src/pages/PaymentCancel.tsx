  ...
  useEffect(() => {
    ...
    const handlePaymentCancellation = async () => {
      ...
      try {
        ...
        if (error) {
          console.error(
            "PaymentCancel: Error updating booking status:",
            error,
            "BookingId:",
            bookingId,
          );
          ...
          console.log(
            "PaymentCancel: Booking status updated to cancelled for",
            bookingId,
          );
        ...
        console.error(
          "PaymentCancel: Error handling payment cancellation:",
          err,
          "BookingId:",
          bookingId,
        );
          ...
          <CardContent className="space-y-6">
            <div className="text-center">
              <p className="text-gray-600 mb-4">
                Ai anulat procesul de plată. Rezervarea ta{" "}
                {success ? "a fost anulată." : "nu a putut fi anulată."}
              </p>
              {error && (
              ...
              {!error && (
                <Alert className="border-orange-200 bg-orange-50">
                  ...
                  <AlertDescription className="text-orange-800">
                    Rezervarea va fi ștearsă automat în următoarele 30 de
                    minute.
                  </AlertDescription>
                </Alert>
              )}
