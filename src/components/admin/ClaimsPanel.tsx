...
export const ClaimsPanel: React.FC = () => {
  ...
  const loadClaims = async () => {
    try {
      ...
      const processedData = (data || []).map((claim) => ({
        ...claim,
        evidence_photos:
          typeof claim.evidence_photos === "string"
  ...
  const updateClaimStatus = async (
    ...
    try {
      ...
      toast.success(
        `Reclamație ${status === "approved" ? "aprobată" : "respinsă"} cu succes`,
      );
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-gray-600 text-sm sm:text-base">
            Administrează reclamațiile utilizatorilor
          </p>
        </div>
      </div>
          ...
          {loading ? (
            ...
            <div className="text-center py-12">
              ...
              <p className="text-gray-600">
                Nu au fost găsite reclamații cu criteriile selectate.
              </p>
            </div>
          ) : (
            <>
                          ...
                          <div className="flex items-center space-x-2">
                            ...
                            <div>
                              <p className="font-medium">
                                {claim.claimant?.full_name || "Necunoscut"}
                              </p>
                          ...
                          claim.evidence_photos.length > 0 ? (
                            <div className="flex items-center space-x-1">
                              ...
                              <span className="text-sm">
                                {claim.evidence_photos.length} foto
                              </span>
                            </div>
                          ) : (
                            <span className="text-gray-500">-</span>
