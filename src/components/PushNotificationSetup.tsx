...
export const PushNotificationSetup: React.FC<PushNotificationSetupProps> = ({
  ...
  const removeSubscriptionFromBackend = async () => {
    ...
    try {
      const { error } = await pushNotificationService.removeSubscription(
        user.id,
      );
      if (error) {
        throw error;
      ...
      <Card className={className}>
        ...
        <CardContent>
          <Alert>
            ...
            <AlertDescription>
              Notificările push nu sunt suportate în acest browser sau pe acest
              dispozitiv.
            </AlertDescription>
          </Alert>
        </CardContent>
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) =>
                      updateNotificationSettings("bookingUpdates", checked)
                    }
                  />
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) =>
                      updateNotificationSettings("messages", checked)
                    }
                  />
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) =>
                      updateNotificationSettings("reviews", checked)
                    }
                  />
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) =>
                      updateNotificationSettings("payments", checked)
                    }
                  />
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) =>
                      updateNotificationSettings("promotions", checked)
                    }
                  />
                </div>
              </div>
