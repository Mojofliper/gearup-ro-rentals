    ...
    switch (error.type) {
      ...
      case "owner_not_ready":
        return {
          ...
          description:
            "Proprietarul echipamentului trebuie să își configureze contul de plată.",
          icon: AlertTriangle,
      ...
      case "network_error":
        return {
          ...
          description:
            "Nu s-a putut conecta la serviciul de plăți. Verificați conexiunea la internet.",
          icon: RefreshCw,
          color: "text-blue-600",
          bgColor: "bg-blue-50",
      ...
      case "validation_error":
        return {
          title: "Date invalide",
          description:
            "Datele introduse nu sunt valide. Vă rugăm să le verificați.",
          icon: AlertTriangle,
      ...
      case "escrow_error":
        return {
          title: "Eroare escrow",
          description:
            "Nu s-a putut crea tranzacția de escrow. Vă rugăm să încercați din nou.",
          icon: Shield,
      ...
      <CardContent className="space-y-4">
        ...
        <Alert className={`${config.borderColor} ${config.bgColor}`}>
          ...
          <AlertDescription>
            {error.message}
            {error.code && (
              <div className="mt-1 text-xs font-mono">Cod: {error.code}</div>
            )}
          </AlertDescription>
        </Alert>
