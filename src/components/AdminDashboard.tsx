...
const UsersPanel = React.lazy(() =>
  import("./admin/UsersPanel").then((m) => ({ default: m.UsersPanel })),
);
const ListingsPanel = React.lazy(() =>
  import("./admin/ListingsPanel").then((m) => ({ default: m.ListingsPanel })),
);
const ClaimsPanel = React.lazy(() =>
  import("./admin/ClaimsPanel").then((m) => ({ default: m.ClaimsPanel })),
);
const AnalyticsPanel = React.lazy(() =>
  import("./admin/AnalyticsPanel").then((m) => ({ default: m.AnalyticsPanel })),
);
const SettingsPanel = React.lazy(() =>
  import("./admin/SettingsPanel").then((m) => ({ default: m.SettingsPanel })),
);
const CleanupPanel = React.lazy(() =>
  import("./admin/CleanupPanel").then((m) => ({ default: m.default })),
);

const navigationItems = [
  {
    path: "overview",
    label: "Vizualizare generală",
    icon: Home,
    color: "text-blue-600",
  },
      ...
      try {
        ...
        recentUsers?.forEach((user) => {
          activities.push({
            ...
            time: format(new Date(user.created_at), "dd MMMM yyyy", {
              locale: ro,
            }),
      ...
      try {
        ...
        recentGear?.forEach((gear) => {
          activities.push({
            ...
            item: gear.title,
            time: format(new Date(gear.created_at), "dd MMMM yyyy", {
              locale: ro,
            }),
      ...
      try {
        ...
        recentBookings?.forEach((booking) => {
          activities.push({
            ...
            time: format(new Date(booking.created_at), "dd MMMM yyyy", {
              locale: ro,
            }),
    ...
    <AdminGuard>
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
        ...
        <div className="flex flex-col lg:flex-row">
          ...
          {/* Sidebar */}
          <aside
            className={`fixed lg:static inset-y-0 left-0 z-40 bg-white/95 backdrop-blur-sm border-r border-gray-200/50 transition-all duration-300 transform ${
              sidebarCollapsed
                ? "translate-x-0"
                ...
                <Route
                  ...
                  element={
                    <AdminModerationQueue
                      isOpen={true}
                      onClose={() => navigate("/admin/overview")}
                    />
                  }
                />
