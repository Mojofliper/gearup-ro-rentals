...
export const MyListings: React.FC = () => {
  ...
  const [gearToDelete, setGearToDelete] = useState<Record<
    string,
    unknown
  > | null>(null);
  ...
  const getStatusBadge = (status: string) => {
    switch (status) {
      ...
      case "maintenance":
        return (
          <Badge className="bg-yellow-100 text-yellow-800">În mentenanță</Badge>
        );
      default:
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100">
        ...
        <div className="container mx-auto px-4 py-6 sm:py-8">
          <div className="flex items-center justify-center py-8 sm:py-12">
            ...
            <span className="ml-2 text-sm sm:text-base text-blue-500">
        ...
        <div className="container mx-auto px-4 py-6 sm:py-8">
          <div className="text-center py-8 sm:py-12">
            ...
            <p className="text-sm sm:text-base text-gray-600 mb-4">
              Nu s-au putut încărca echipamentele tale.
            </p>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4">
            ...
            <div>
              ...
              <p className="text-sm sm:text-base text-gray-600">
                Gestionează echipamentele tale pentru închiriere
              </p>
            </div>
          </div>
          <Button
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-lg sm:text-2xl font-bold text-green-600">
                    {myGear?.filter((gear) => gear.status === "available")
                      .length || 0}
                  </p>
                </div>
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-lg sm:text-2xl font-bold text-blue-600">
                    {myGear?.filter((gear) => gear.status === "rented")
                      .length || 0}
                  </p>
                </div>
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-lg sm:text-2xl font-bold text-yellow-600">
                    {myGear?.filter(
                      (gear) => gear.moderation_status === "pending",
                    ).length || 0}
                  </p>
                </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center space-x-1 text-xs sm:text-sm text-gray-600">
                      ...
                      <span className="truncate">
                        {(gear.pickup_location as string) ||
                          "Locație necunoscută"}
                      </span>
                    </div>
                    ...
                    <div className="text-xs sm:text-sm text-gray-500">
                      Adăugat pe{" "}
                      {format(
                        new Date(gear.created_at as string),
                        "dd MMM yyyy",
                      )}
                    </div>
                  </div>
        ...
        <DialogContent className="w-[95vw] max-w-md sm:max-w-lg">
          <DialogHeader>
            ...
            <DialogDescription className="text-sm sm:text-base">
              Ești sigur că vrei să ștergi "{gearToDelete?.title as string}"?
