...
export const ClaimStatusBadge: React.FC<ClaimStatusBadgeProps> = ({
  ...
  const getStatusConfig = (status: string) => {
    ...
    const isCurrentUserClaim =
      currentUserId && claim?.claimant_id === currentUserId;
      ...
      case "pending":
        return {
          label:
            claimantType === "renter"
              ? isCurrentUserClaim
                ? "Revendicare ta în așteptare"
                : "Revendicare chiriaș în așteptare"
              : isCurrentUserClaim
                ? "Revendicare ta în așteptare"
                : "Revendicare proprietar în așteptare",
      ...
      case "under_review":
        return {
          label:
            claimantType === "renter"
              ? isCurrentUserClaim
                ? "Revendicare ta în revizuire"
                : "Revendicare chiriaș în revizuire"
              : isCurrentUserClaim
                ? "Revendicare ta în revizuire"
                : "Revendicare proprietar în revizuire",
      ...
      case "approved":
        return {
          label:
            claimantType === "renter"
              ? isCurrentUserClaim
                ? "Revendicare ta aprobată"
                : "Revendicare chiriaș aprobată"
              : isCurrentUserClaim
                ? "Revendicare ta aprobată"
                : "Revendicare proprietar aprobată",
      ...
      case "rejected":
        return {
          label:
            claimantType === "renter"
              ? isCurrentUserClaim
                ? "Revendicare ta respinsă"
                : "Revendicare chiriaș respinsă"
              : isCurrentUserClaim
                ? "Revendicare ta respinsă"
