...
export const EditGear: React.FC = () => {
  ...
  const validateForm = () => {
    ...
    if (!formData.title.trim()) {
      ...
      errors.title =
        "Numele echipamentului trebuie să aibă între 3 și 100 de caractere";
    }

    if (
      formData.description &&
      !validateGearDescription(formData.description)
    ) {
      errors.description =
        "Descrierea trebuie să aibă între 10 și 1000 de caractere";
    }
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const updates = {
      ...
      pickup_location: formData.pickup_location
        ? sanitizeInput(formData.pickup_location)
        : "Romania",
    ...
    updateGear(
      ...
      },
      {
        ...
        onError: (error: unknown) => {
          toast.error(
            "Eroare la actualizarea echipamentului. Te rugăm să încerci din nou.",
          );
        ...
        <div className="container mx-auto px-4 py-6 sm:py-8">
          <div className="text-center">
            ...
            <h2 className="text-lg sm:text-xl font-semibold mb-2">
              Echipamentul nu a fost găsit
            </h2>
            <p className="text-sm sm:text-base text-gray-600 mb-4">
              Echipamentul pe care încerci să îl editezi nu există sau nu ai
              permisiunea să îl accesezi.
            </p>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4">
            ...
            <div>
              <h1 className="text-2xl sm:text-3xl font-bold text-gray-900">
                Editează echipamentul
              </h1>
              <p className="text-sm sm:text-base text-gray-600">
                Actualizează informațiile despre echipamentul tău
              </p>
            </div>
          </div>
          <Badge
            ...
            <CardContent className="space-y-4 sm:space-y-6">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
                ...
                <div>
                  ...
                  >
                    <SelectTrigger
                      className={`mt-1 ${validationErrors.category_id ? "border-red-500" : ""}`}
                    >
                ...
                <div>
                  ...
                  >
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="Satisfăcătoare">
                        Satisfăcătoare
                      </SelectItem>
                    </SelectContent>
                  </Select>
            ...
            <CardContent className="space-y-3 sm:space-y-4">
              <div className="flex flex-col sm:flex-row gap-2">
                <Input
                  ...
                  onKeyPress={(e) =>
                    e.key === "Enter" && (e.preventDefault(), addIncludedItem())
                  }
                  className="flex-1"
                />
                <Button
          ...
          <Card>
            ...
            <CardContent>
              <div className="flex items-center space-x-2">
                ...
                />
                <Label htmlFor="is_available" className="text-sm sm:text-base">
